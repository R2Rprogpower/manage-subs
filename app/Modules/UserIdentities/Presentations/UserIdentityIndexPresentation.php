...
class UserIdentityIndexPresentation extends Presentation implements PresentationInterface
{
    /**
    ...
    public function present(mixed $data): array
    {
        ...
        /** @var Collection<int, UserIdentity> $data */
        return $data->values()->map(function (UserIdentity $userIdentity): array {
            return [
                'id' => $userIdentity->id,
